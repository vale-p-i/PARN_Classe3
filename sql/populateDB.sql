...
INSERT INTO Utente (N_Reg, Nome, Mail, Pass, Regione, Provincia, Foto, CAP, Telefono, Citta, Via)
VALUES (5, 'Mark Green', 'm.green@gmail.com', 'b133a0c0e9bee3be20163d2ad31d6248db292aa6dcb1ee087a2aa50e0fc75ae2', 'Piemonte', 'TO', 'foto_green.jpeg', '10100', '+39 0101234567', 'Torino', 'Via Roma');
INSERT INTO Azienda (Utente, P_IVA, Rag_Soc, Link, ADI, N_Dip, Sett_Comp)
...
INSERT INTO Annuncio (ID, Azienda, Attivo, Sede, N_Persone, Descrizione, Scadenza, Requisiti, Keyword, Preferenze, Ruolo)
VALUES (3, 1, 1,  1, 2, 'Cercasi sviluppatore web con esperienza in C e Rust', '2023-02-13', 'Conoscenza avanzata di C e Rust', 'sviluppatore, sistemi operativi', 'Esperienza in progetti complessi', 'Sviluppatore buono');
#########################CANDIDATURA#########################
